...
<link href="https://unpkg.com/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.css" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/updateenrol.css') }}">
@endsection
@section('scripts')
              ...
              <div class="col-md-12 col-xs-12">
                <div class="x_panel">
                 ...
                 @endif
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="POST" action="{{ route('student.update.enrolment', $student->id)}}" enctype="multipart/form-data">
                    @csrf
                    <fieldset id="field-value">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group has-feedback">
                        ...
                        <select class="form-control has-feedback-left" name="house_id" id="house">
                            <option value="" class="r"> Select...</option>
                            @foreach($houses as $house)
                            <option value="{{ $house->id }}" {{ $student->house->id == $house->id? 'selected': '' }} >{{ $house->name }}({{ $house->number->num }})({{ $house->color->name }})</option>
                            @endforeach
                          </select>
                      </div>
                    ...
                    <fieldset>
                      ...
                      <div class="form-group but">
                        <div class="btn-group">
                        <button class="btn  btn-success" type="submit"><i class="fa fa-save mr-1 butt"></i>Update Record</button>
                        </div>
                      </div>
                    </form>
                  </div>
