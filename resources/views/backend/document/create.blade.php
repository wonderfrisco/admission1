                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    @if ($errors->any())
                     ...
                     @endforeach
                 @endif
                    <form class="form-horizontal form-label-left input_mask" method="POST" action="{{ route('document.store')}}" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <input type="file" id="upload"  name="document"  required />
                      </div>

                      {{-- <div class="ln_solid"></div> --}}
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success"><i class="fa fa-plus-circle mr-1"></i>Save Document</button>
                        </div>
                      </div>
                    </form>
                  </div>
