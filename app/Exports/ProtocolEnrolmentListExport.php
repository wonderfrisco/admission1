...
class ProtocolEnrolmentListExport implements FromView, WithHeadings, ShouldAutoSize, WithStyles, WithDefaultStyles
{
    protected  $data;
    /**
    ...
    */
    ...
    {
        return view('backend.protocol.protocolEnrolmentListExcel', [
            'data' => $this->data
        ]);
    }
