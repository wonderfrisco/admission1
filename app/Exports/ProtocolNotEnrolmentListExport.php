...
class ProtocolNotEnrolmentListExport implements FromView, WithHeadings, ShouldAutoSize, WithMapping, WithStyles, WithDefaultStyles
{
    protected  $data;
    /**
    ...
    */
    ...
    {
        return view('backend.protocol.protocolnotenrolExcel', [
            'data' => $this->data
        ]);
    }
